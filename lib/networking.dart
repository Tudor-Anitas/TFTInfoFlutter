...
class ApiCalls {
  ...
  String _key = 'RGAPI-6bd4a252-743f-4c2c-afde-8ed2b6cf483b';
  Future<Map<String, dynamic>> getSummoner(
      String summonerName, String region) async {
    Uri uri;
    Uri.parse(
        "https://eun1.api.riotgames.com/tft/summoner/v1/summoners/by-name/" +
            summonerName +
            "?api_key=" +
            _key);
    ...
    switch (region) {
      case 'br1':
        uri = Uri.parse(
            "https://br1.api.riotgames.com/tft/summoner/v1/summoners/by-name/" +
                summonerName +
                "?api_key=" +
                _key);
        break;
      ...
      case 'jp1':
        uri = Uri.parse(
            "https://jp1.api.riotgames.com/tft/summoner/v1/summoners/by-name/" +
                summonerName +
                "?api_key=" +
                _key);
        break;
      ...
      case 'ru':
        uri = Uri.parse(
            "https://ru.api.riotgames.com/tft/summoner/v1/summoners/by-name/" +
                summonerName +
                "?api_key=" +
                _key);
        break;
      case 'tr1':
        uri = Uri.parse(
            "https://tr1.api.riotgames.com/tft/summoner/v1/summoners/by-name/" +
                summonerName +
                "?api_key=" +
                _key);
        break;
  ...
  Future<String> getRank(String id, String region) async {
    ...
    switch (region) {
      case 'br1':
        uri = Uri.parse(
            'https://br1.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
      case 'eun1':
        uri = Uri.parse(
            'https://eun1.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
      ...
      case 'jp1':
        uri = Uri.parse(
            'https://jp1.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
      ...
      case 'oc1':
        uri = Uri.parse(
            'https://oc1.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
      case 'ru':
        uri = Uri.parse(
            'https://ru.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
      case 'tr1':
        uri = Uri.parse(
            'https://tr1.api.riotgames.com/tft/league/v1/entries/by-summoner/' +
                id +
                '?api_key=' +
                _key);
        break;
  ...
  Future<List<String>> getMatches(String puuid, String region) async {
    ...
    for (String match in finalResponse) matchIds.add(match);

    return matchIds;
  }

  Future<Map<String, dynamic>> getMatchDetails(
      String puuid, String matchId, String region) async {
    Uri uri;
    ...
    switch (region) {
      ...
      case 'america':
        ...
        break;
      case 'asia':
        uri = Uri.parse('https://asia.api.riotgames.com/tft/match/v1/matches/' +
            matchId +
            '?api_key=' +
            _key);
        break;
    ...
    var response = await http.get(uri);
    var finalResponse = json.decode(response.body);
    if (finalResponse['info']['participants'] != null)
      for (var participant in finalResponse['info']['participants'])
        if (participant['puuid'] == puuid) {
          ...
          player['total_damage_to_players'] =
